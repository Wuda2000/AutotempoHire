...
def is_duplicate_transaction(self, transaction_id):
    ...
    return False  # Placeholder for actual duplicate check

def validate_payment_details(self, phone_number, amount):
    """Validate user payment details before processing."""
    # Logic to validate phone number and amount
    return True  # Placeholder for actual validation logic

def process_payment(user, driver, amount, callback_url, transaction_id):
    ...
    """
    mpesa = MpesaPayment()
    response = mpesa.initiate_payment(user.phone_number, amount, callback_url)
