...
class MpesaGateway:
    ...
    def __init__(self):
        ...
        self.token_url = os.getenv("MPESA_TOKEN_URL", "https://api.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials")  # Production URL
        self.stk_url = os.getenv("MPESA_STK_URL", "https://api.safaricom.co.ke/mpesa/stkpush/v1/processrequest")  # Production URL
        self.sandbox_token_url = os.getenv("MPESA_SANDBOX_TOKEN_URL", "https://sandbox.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials")  # Sandbox URL
        self.sandbox_stk_url = os.getenv("MPESA_SANDBOX_STK_URL", "https://sandbox.safaricom.co.ke/mpesa/stkpush/v1/processrequest")  # Sandbox URL
