...
class CustomUserAdmin(UserAdmin):
    list_display = ('username', 'email', 'role', 'unique_id', 'is_verified', 'is_staff', 'password_last_changed', 'password_reset_token')
    ...
    def password_last_changed(self, obj):
        return obj.password_last_changed if obj.password_last_changed else "Never Changed"
    password_last_changed.short_description = "Password Last Changed"
